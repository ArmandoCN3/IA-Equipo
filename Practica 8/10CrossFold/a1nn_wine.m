...
for j = 1:9
    if j ==1
        pruebas = readtable('wine_fold_2.csv');
        pruebas = table2array(pruebas);
    end
    if j ==2
        pruebas = readtable('wine_fold_3.csv');
        pruebas = table2array(pruebas);
    end
    if j ==3
        pruebas = readtable('wine_fold_4.csv');
        pruebas = table2array(pruebas);
    end
    if j ==4
        pruebas = readtable('wine_fold_5.csv');
        pruebas = table2array(pruebas);
    end
    if j ==5
        pruebas = readtable('wine_fold_6.csv');
        pruebas = table2array(pruebas);
    end
    if j ==6
        pruebas = readtable('wine_fold_7.csv');
        pruebas = table2array(pruebas);
    end
    if j ==7
        pruebas = readtable('wine_fold_8.csv');
        pruebas = table2array(pruebas);
    end
    if j ==8
        pruebas = readtable('wine_fold_9.csv');
        pruebas = table2array(pruebas);
    end
    if j ==9
        pruebas = readtable('wine_fold_10.csv');
        pruebas = table2array(pruebas);
    end
...
matriz
accuracy = ((matriz(1,1)*100/45) + (matriz(2,2)*100/25) + (matriz(3,3)*100/38))*100/300;
